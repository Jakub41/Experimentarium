...
SearchComponent = __decorate([
    core_1.Component({
        ...
        template: "<div class=\"form-inline\">\n                <div class=\"form-group\">\n                    <label><h3>{{title}}</h3></label>\n                </div>\n                <div class=\"form-group\">\n                    <div class=\"col-lg-12\">\n                        <input class=\"input-lg\" placeholder=\"Enter any text to filter\" (paste)=\"getPasteData($event)\" (keyup)=\"getEachChar($event.target.value)\" type=\"text\" [(ngModel)]=\"listFilter\" /><img src=\"http://www.iconninja.com/files/418/542/435/cross-icon.png\" width=\"32\" height=\"32\" class=\"cross-btn\" (click)=\"clearFilter()\" *ngIf=\"listFilter\"/>\n                    </div>\n                </div>\n                <div class=\"form-group\">\n                    <div *ngIf='listFilter'>\n                        <div class=\"h3 text-muted\">Filter by: {{listFilter}}</div>\n                    </div>\n                </div>\n            </div>"
    })
], SearchComponent);
